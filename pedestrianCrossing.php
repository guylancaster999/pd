<?php 
require "page.php";
$pg= new pageCls("Pedestrian Crossing (failing to accord precedence)");?>
   <div id="wrapper">
      <div id="header">
          <?php $pg->banner(); ?>
      </div><!-- #header -->
          ...
          <tr>
            <td>
				...
				<?php $pg->displayHeader("Pedestrian Crossing (failing to accord precedence)");?>
				  ...
				  Not the offence  can be committed by a cyclist.
					<br/>  <br/>
				  Note that the limits of the crossing are marked by studs which are adjacent to the striped lines. 
				  The broken white line along the crossing is to indicate where vehicles should stop.
					<br/>  <br/>
