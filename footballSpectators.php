      ...
      <div id="content">
        <table class="wide">
          ...
          <?php $pg->displayHeader();?>
			...
			<br/><br/>
			It is also an offence to take part in chanting at a football match of a indecent or racialist nature. This is contrary to the Football Offences Act 1991.
			<br/><br/>
