        ...
        <table class="wide">
          ...
          <?php $pg->displayHeader();?>
		   These offences are increasingly common in our heavily monitored and patrolled town centres.
			 ...
			 <br/><br/>
			 The police like to prosecute and arrest for public order offences, the press like to criticise the young for the commission of lawless behaviour in our town centres.  
			 This of course sends the climate of fear and contributes to a feeling of lawlessness that results in heavy handed policing and prosecution of the many.
			 <br/><br/>
			 ...
			 <ul>
			   <li><A href="#violentDisorder">Violent Disorder: s2 Public Order Act 1986.</a></li>
			   <li><a href="#affray">Affrays: S3 public order act 1986</a></li>
			   <li><a href="#threateningBehaiviour">Threatening behaviour, fear or provocation of violence</a></li>
			   <li><a href="#harassment">Harassment: alarm or distress</a></li>
			...
			<a id="violentDisorder"></a>
			<h2>Violent Disorder; s2 Public Order Act 1986</h2>
			 ...
			 <br/><br/>
			 In the case of Jackson-Crisp 1989 a group of 12 youths fighting and kicking in the town centre, late at night inspiring fear in the general public was sufficiently serious to merit a 12 month custodial sentence.
			 <br/><br/>
			 These are offences that the court will sentence severely if convicted.
			<a id="affray"></a>
			<h2>AFFRAY: s3 PUBLIC ORDER ACT 1986.</h2>
			...
			<h2>Threatening Behaviour :Fear or Provocation of Violence</h2>
			 ...
			 <br/><br/>
			 In law a person is guilty if with intent to cause a person harassment, alarm or distress, if he uses threatening abusive words or behaviour.
			 <br/><br/>
			...
			<a id="harassment"></a>
			 ...
			 <br/><br/>
			 This is the most common form of public order offence. 
			 Usually when a person has lost their temper with a police officer and told them to 'fuck off'.
			 <br/><br/>
			 ...
			 We have successfully defended many of these matters arguing that:
				<blockquote>A client had no reason to believe that a person would be caused harassment, alarm or distress by the words used.
				 <br/><br/>
				 That he was inside a dwelling, and that his conduct was reasonable.
				 This is to be proved objectively.
				</blockquote>
			 ...
			 <a id="football"></a>
			<h2>Football Offences, Football Banning Orders</h2>
			  This is an area of the law few solicitors specialise or have an interest in. We have expertise in this area, because we play and follow football.  
			  We understand the emotions and passion that the game generates.  
			  We also believe that the football stadium is a venue where passion and feelings should be vented and that this forum should be a place where you can 'let off steam' this is part of the tradition of the game and the culture of our football grounds.
			  <br/><br/>
			 ...
			 <br/><br/>
			 The most draconian and cruelly used sentence for football related offending is the making of <B>Football Banning Orders</b>.
			 <br/><br/>
			 Whereby a person must have been convicted of an offence connected with a football match, committed 24 hours before or after the match.
			 <br/><br/>
			...
			<h2>Offences relating to Firearms</h2>
			 This is an evolving area of law, currently under statutory reform, if you are charged with any of these offences, <a href="contact.php" title="Contact Paul Darnborough">contact us</a> immediately.
        </div>
	  </td>
